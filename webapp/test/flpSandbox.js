					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#ciseffortsanalysis-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"ciseffortsanalysis-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cis.effortsanalysis",
									"url": sap.ui.require.toUrl("cis/effortsanalysis")
								}
							}
						}
					}
